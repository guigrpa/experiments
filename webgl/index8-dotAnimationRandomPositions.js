...
void main() {
  float rand1 = fract(sin(dot(aPosition, vec2(12.9898, 78.233)) * uRandom) * 43758.5453);
  float rand2 = fract(sin(dot(aPosition, vec2(12.9898, 78.233)) * uRandom * uRandom) * 43758.5453);
  gl_Position = vec4(vec2(rand1, rand2) * 2.0 - 1.0, 0, 1);
  gl_PointSize = 2.0;
}`;
